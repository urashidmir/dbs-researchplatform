...
class BP_Core extends BP_Component {
	...
	private function bootstrap() {
		...
		$bp->optional_components = apply_filters( 'bp_optional_components', array( 'activity', 'blogs', 'forums', 'friends', 'groups', 'experiments', 'messages', 'notifications', 'settings', 'xprofile' ) );
	...
	public function setup_globals( $args = array() ) {
        ...
        $bp->grav_default->experiment = apply_filters( 'bp_experiment_gravatar_default', $bp->grav_default->user );
