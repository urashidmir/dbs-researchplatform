	...
	<li class="align-right" id="bp-adminbar-visitrandom-menu">
		...
		<ul class="random-list">
            ...
            <?php if ( bp_is_active( 'experiments' ) ) : ?>
                ...
                <li class="alt"><a href="<?php echo trailingslashit( bp_get_root_domain() . '/' . bp_get_experiments_root_slug() ) . '?random-experiment' ?>"  rel="nofollow"><?php _e( 'Random Experiment', 'buddypress' ) ?></a></li>
