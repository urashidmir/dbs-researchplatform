...
class BP_Admin {
	...
	public function register_admin_settings() {
		...
		if ( bp_is_active( 'experiments' ) ) {
			...
			// Add the main section
			add_settings_section( 'bp_experiments',        __( 'Experiments Settings',  'buddypress' ), 'bp_admin_setting_callback_experiments_section',   'buddypress'              );
            
			// Allow subscriptions setting
			add_settings_field( 'bp_restrict_experiment_creation', __( 'Experiment Creation',   'buddypress' ), 'bp_admin_setting_callback_experiment_creation',   'buddypress', 'bp_experiments' );
			register_setting  ( 'buddypress',         'bp_restrict_experiment_creation',   'intval'                                                                                );
		}
