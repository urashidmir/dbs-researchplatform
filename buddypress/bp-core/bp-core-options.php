...
function bp_get_default_options() {
	...
	$options = array (
        ...
        // Base profile experiments name
        'bp-xprofile-base-experiment-name'     => 'BaseExperiment',
        ...
        // @todo Move this into the experiments component
                      
        // Restrict experiment creation to super admins
        'bp_restrict_experiment_creation'      => false,
        ...
        'widget_bp_experiments_widget'               => false,
...
/**
 * Is experiment creation turned off?
 *
 * @since BuddyPress (1.6.0)
 *
 * @todo Move into experiments component.
 * @uses bp_get_option() To get the experiment creation.
 *
 * @param bool $default Optional. Fallback value if not found in the database.
 *        Default: true.
 * @return bool True if experiment creation is restricted, otherwise false.
 */
function bp_restrict_experiment_creation( $default = true ) {
    return (bool) apply_filters( 'bp_restrict_experiment_creation', (bool) bp_get_option( 'bp_restrict_experiment_creation', $default ) );
}
