 ...
 *           about returned users, such as total group, experiment and friend counts.
...
class BP_Core_User {
	...
	/**
	 * The total number of experiments the user is a part of.
	 *
	 * Example: "1 experiment", "2 experiments"
	 *
	 * @var string
	 */
	public $total_experiments;
	...
	public function populate_extras() {
        ...
        if ( bp_is_active( 'experiments' ) ) {
			$this->total_experiments = BP_Experiments_Member::total_experiment_count( $this->id );
			$this->total_experiments = sprintf( _n( '%d experiment', '%d experiments', $this->total_experiments, 'buddypress' ), $this->total_experiments );
		}
	}
