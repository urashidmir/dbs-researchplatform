...
function bp_core_admin_get_components( $type = 'all' ) {
	...
	$optional_components = array(
        ...
        'experiments'   => array(
                'title'       => __( 'User Experiments', 'buddypress' ),
                'description' => __( 'Experiments allow your users to organize themselves into specific public, private or hidden sections with separate activity streams and member listings.', 'buddypress' )
        ),
		'forums'   => array(
