...
<?php if ( bp_is_experiment_admin_screen( 'edit-details' ) ) : ?>
	...
	<input type="text" name="experiment-name" id="experiment-name" value="<?php bp_experiment_name(); ?>" aria-required="true" />

	<label for="experiment-desc"><?php _e( 'Experiment Description (required)', 'buddypress' ); ?></label>
	<textarea name="experiment-desc" id="experiment-desc" aria-required="true"><?php bp_experiment_description_editable(); ?></textarea>
...
<?php if ( bp_is_experiment_admin_screen( 'experiment-avatar' ) ) : ?>
	...
	<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<?php if ( bp_get_experiment_has_avatar() ) : ?>
				...
				<?php bp_button( array( 'id' => 'delete_experiment_avatar', 'component' => 'experiments', 'wrapper_id' => 'delete-experiment-avatar-button', 'link_class' => 'edit', 'link_href' => bp_get_experiment_avatar_delete_link(), 'link_title' => __( 'Delete Avatar', 'buddypress' ), 'link_text' => __( 'Delete Avatar', 'buddypress' ) ) ); ?>
...
<?php if ( bp_is_experiment_admin_screen( 'membership-requests' ) ) : ?>
	...
	<?php if ( bp_experiment_has_membership_requests() ) : ?>

		<ul id="request-list" class="item-list">
			<?php while ( bp_experiment_membership_requests() ) : bp_experiment_the_membership_request(); ?>

				<li>
					<?php bp_experiment_request_user_avatar_thumb(); ?>
					<h4><?php bp_experiment_request_user_link(); ?> <span class="comments"><?php bp_experiment_request_comment(); ?></span></h4>
					<span class="activity"><?php bp_experiment_request_time_since_requested(); ?></span>

					<?php do_action( 'bp_experiment_membership_requests_admin_item' ); ?>

					<div class="action">

						<?php bp_button( array( 'id' => 'experiment_membership_accept', 'component' => 'experiments', 'wrapper_class' => 'accept', 'link_href' => bp_get_experiment_request_accept_link(), 'link_title' => __( 'Accept', 'buddypress' ), 'link_text' => __( 'Accept', 'buddypress' ) ) ); ?>

						<?php bp_button( array( 'id' => 'experiment_membership_reject', 'component' => 'experiments', 'wrapper_class' => 'reject', 'link_href' => bp_get_experiment_request_reject_link(), 'link_title' => __( 'Reject', 'buddypress' ), 'link_text' => __( 'Reject', 'buddypress' ) ) ); ?>

						<?php do_action( 'bp_experiment_membership_requests_admin_item_action' ); ?>
