...
<div id="item-header-content">
	<h2><a href="<?php bp_experiment_permalink(); ?>" title="<?php bp_experiment_name(); ?>"><?php bp_experiment_name(); ?></a></h2>
	<span class="highlight"><?php bp_experiment_type(); ?></span> <span class="activity"><?php printf( __( 'active %s', 'buddypress' ), bp_get_experiment_last_active() ); ?></span>
