...
<?php if ( bp_is_active( 'experiments' ) ) : ?>

<?php if ( bp_get_total_experiment_count_for_user( bp_loggedin_user_id() ) ) : ?>

<li id="activity-experiments"><a href="<?php echo bp_loggedin_user_domain() . bp_get_activity_slug() . '/' . bp_get_experiments_slug() . '/'; ?>" title="<?php esc_attr_e( 'The activity of experiments I am a member of.', 'buddypress' ); ?>"><?php printf( __( 'My Experiments <span>%s</span>', 'buddypress' ), bp_get_total_experiment_count_for_user( bp_loggedin_user_id() ) ); ?></a></li>
...
<option value="created_experiment"><?php _e( 'New Experiments', 'buddypress' ); ?></option>
