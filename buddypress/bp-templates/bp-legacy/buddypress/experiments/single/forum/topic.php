<?php do_action( 'bp_before_experiment_forum_topic' ); ?>
...
<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
	...
	<div id="topic-meta">
		...
		<?php if ( bp_experiment_is_admin() || bp_experiment_is_mod() || bp_get_the_topic_is_mine() ) : ?>
		...
		<?php do_action( 'bp_experiment_forum_topic_meta' ); ?>
	...
	<?php if ( bp_has_forum_topic_posts() ) : ?>
		...
		<?php do_action( 'bp_before_experiment_forum_topic_posts' ); ?>
			...
			<?php while ( bp_forum_topic_posts() ) : bp_the_forum_topic_post(); ?>
				...
				<li id="post-<?php bp_the_topic_post_id(); ?>" class="<?php bp_the_topic_post_css_class(); ?>">
					...
					<div class="admin-links">
						<?php if ( bp_experiment_is_admin() || bp_experiment_is_mod() || bp_get_the_topic_post_is_mine() ) : ?>
							<?php bp_the_topic_post_admin_links(); ?>
						<?php endif; ?>

						<?php do_action( 'bp_experiment_forum_post_meta' ); ?>
		...
		<?php do_action( 'bp_after_experiment_forum_topic_posts' ); ?>
	...
	<?php if ( ( is_user_logged_in() && 'public' == bp_get_experiment_status() ) || bp_experiment_is_member() ) : ?>

		<?php if ( bp_get_the_topic_is_last_page() ) : ?>

			<?php if ( bp_get_the_topic_is_topic_open() && !bp_experiment_is_user_banned() ) : ?>

				<div id="post-topic-reply">
					<p id="post-reply"></p>

					<?php if ( bp_experiments_auto_join() && !bp_experiment_is_member() ) : ?>
						<p><?php _e( 'You will auto join this experiment when you reply to this topic.', 'buddypress' ); ?></p>
					<?php endif; ?>

					<?php do_action( 'experiments_forum_new_reply_before' ); ?>
					...
					<?php do_action( 'experiments_forum_new_reply_after' ); ?>

					<?php wp_nonce_field( 'bp_forums_new_reply' ); ?>
				</div>

			<?php elseif ( !bp_experiment_is_user_banned() ) : ?>
...
<?php do_action( 'bp_after_experiment_forum_topic' ); ?>
