<?php do_action( 'bp_before_experiment_forum_edit_form' ); ?>
	...
	<form action="<?php bp_forum_topic_action(); ?>" method="post" id="forum-topic-form" class="standard-form">
		...
		<?php if ( bp_is_edit_topic() ) : ?>
			...
			<div id="edit-topic">
				...
				<?php do_action( 'bp_experiment_before_edit_forum_topic' ); ?>
				...
				<?php do_action( 'bp_experiment_after_edit_forum_topic' ); ?>
		...
		<?php else : ?>
			...
			<div id="edit-post">
				...
				<?php do_action( 'bp_experiment_before_edit_forum_post' ); ?>

				<textarea name="post_text" id="post_text"><?php bp_the_topic_post_edit_text(); ?></textarea>

				<?php do_action( 'bp_experiment_after_edit_forum_post' ); ?>
...
<?php do_action( 'bp_after_experiment_forum_edit_form' ); ?>
